// Server runs the simulation 30 times/sec (33ms tick). Budget allows up to
// ~28ms of game logic before the next tick — much safer than the old 20ms.
...
export const MIN_SAFE_SPAWN_DIST = 200; // minimum px between any spawn point and any alive player
...
export const ARAM_MINION_GOLD_REWARD     = 8;
export const ARAM_MINION_XP_REWARD       = 20; // slightly less XP than MOBA (shorter game)
export const ARAM_RESPAWN_BASE_MS        = 4_000;
export const ARAM_PLAYER_KILL_GOLD       = 50;
export const ARAM_PLAYER_KILL_XP         = 120;
export const ARAM_TOWER_KILL_GOLD        = 100;
...
export const MOBA_MINION_GOLD_REWARD   = 12;
export const MOBA_MINION_XP_REWARD     = 25;  // XP per minion kill (levels like LoL)
export const MOBA_RESPAWN_BASE_MS      = 8_000;
export const MOBA_PLAYER_KILL_GOLD     = 80;
export const MOBA_PLAYER_KILL_XP       = 150; // XP for killing an enemy player
export const MOBA_TOWER_KILL_GOLD      = 150;
// Item shop
export const MOBA_PASSIVE_GOLD_RATE        = 5;        // g per tick
export const MOBA_PASSIVE_GOLD_INTERVAL_MS = 10_000;   // tick every 10s
export const MOBA_ITEM_SLOTS               = 6;
